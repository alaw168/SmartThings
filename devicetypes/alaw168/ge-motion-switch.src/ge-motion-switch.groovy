/**
 *  GE Motion Switch
 *	Author: Alvin Law (@alaw168)
 *
 * Based off version of device handler from Matt LeBaugh (@mlebaugh) 
 * Copyright (C) Alvin Law
 *
...
metadata {
	definition (name: "GE Motion Switch", namespace: "alaw168", author: "Alvin Law") {
