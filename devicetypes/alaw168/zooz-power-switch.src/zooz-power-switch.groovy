...
*/
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"combo", type: "generic", width: 6, height: 4, canChangeIcon: true){
			tileAttribute ("device.acceleration", key: "PRIMARY_CONTROL") {
				attributeState "inactive", label:'Inactive', backgroundColor: "#cccccc"
				attributeState "active", label:'Active', backgroundColor: "#00a0dc"
			}
			tileAttribute ("device.power", key: "SECONDARY_CONTROL") {
				attributeState "power", label:'Power: ${currentValue}W', icon: "st.Appliances.appliances17"
			}
		}
		...
		standardTile("reset", "device.reset", width: 2, height: 2, decoration: "flat") {
		...
		main "combo"
		details(["combo", "voltage", "current", "energy", "switch", "reset", "refresh", "history"])
	}
}
